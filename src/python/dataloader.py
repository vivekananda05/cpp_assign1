...
#             batch_labels_data.append(label_data)
        
#         # Convert to Tensor objects
#         batch_images_tensor = Tensor(batch_images_data)  # Shape: [batch, channels, height, width]
#         batch_labels_tensor = Tensor(batch_labels_data)  # Shape: [batch, num_classes]
